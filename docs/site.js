...
(function () {
    ...
    var REPOSITORY = 'pavel-zheltiakov/Ava3DControl';
    ...
    function card(release) {
        ...
        return '<article class="rel">' +
            ...
            '<pre class="install"><code>dotnet add package Ava3DControl --version ' + escape(version) +
            '</code></pre>' +
            ...
            '<a href="https://www.nuget.org/packages/Ava3DControl/' + escape(version) + '">NuGet</a></p>' +
            '</article>';
    }
