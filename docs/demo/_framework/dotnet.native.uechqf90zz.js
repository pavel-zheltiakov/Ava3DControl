...
function ___syscall_fadvise64(fd, offset, len, advice) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(6, 0, 0, fd, offset, len, advice);
 return 0;
}

function ___syscall_fchmod(fd, mode) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(7, 0, 1, fd, mode);
 try {
  FS.fchmod(fd, mode);
  return 0;
 } catch (e) {
...
function ___syscall_statfs64(path, size, buf) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(11, 0, 1, path, size, buf);
 try {
  path = SYSCALLS.getStr(path);
...
function ___syscall_ioctl(fd, op, varargs) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(15, 0, 1, fd, op, varargs);
 SYSCALLS.varargs = varargs;
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
  switch (op) {
...
function ___syscall_readlinkat(dirfd, path, buf, bufsize) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(20, 0, 1, dirfd, path, buf, bufsize);
 try {
  path = SYSCALLS.getStr(path);
  path = SYSCALLS.calculateAt(dirfd, path);
...
function _fd_pread(fd, iov, iovcnt, offset, pnum) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(36, 0, 1, fd, iov, iovcnt, offset, pnum);
 offset = bigintToI53Checked(offset);
 try {
  if (isNaN(offset)) return 61;
  var stream = SYSCALLS.getStreamFromFD(fd);
...
function _fd_pwrite(fd, iov, iovcnt, offset, pnum) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(37, 0, 1, fd, iov, iovcnt, offset, pnum);
 offset = bigintToI53Checked(offset);
 try {
  if (isNaN(offset)) return 61;
  var stream = SYSCALLS.getStreamFromFD(fd);
...
function _fd_seek(fd, offset, whence, newOffset) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(39, 0, 1, fd, offset, whence, newOffset);
 offset = bigintToI53Checked(offset);
 try {
  if (isNaN(offset)) return 61;
  var stream = SYSCALLS.getStreamFromFD(fd);
...
function _fd_sync(fd) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(40, 0, 1, fd);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
...
DOTNET.setup({
 ...
 gitHash: "f7d90799ce4ef09a0bb257852a57248d2a8fb8dd"
});

var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_chmod, ___syscall_connect, ___syscall_faccessat, ___syscall_fadvise64, ___syscall_fchmod, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_fstatfs64, ___syscall_statfs64, ___syscall_ftruncate64, ___syscall_getcwd, ___syscall_getdents64, ___syscall_ioctl, ___syscall_lstat64, ___syscall_mkdirat, ___syscall_newfstatat, ___syscall_openat, ___syscall_readlinkat, ___syscall_renameat, ___syscall_rmdir, ___syscall_sendto, ___syscall_socket, ___syscall_stat64, ___syscall_unlinkat, ___syscall_utimensat, __mmap_js, __munmap_js, _emscripten_force_exit, __emscripten_runtime_keepalive_clear, _environ_get, _environ_sizes_get, _fd_close, _fd_fdstat_get, _fd_pread, _fd_pwrite, _fd_read, _fd_seek, _fd_sync, _fd_write ];
...
var wasmImports = {
 ...
 /** @export */ glMultiDrawArraysInstancedBaseInstanceWEBGL: _glMultiDrawArraysInstancedBaseInstanceWEBGL,
 /** @export */ glMultiDrawElementsInstancedBaseVertexBaseInstanceWEBGL: _glMultiDrawElementsInstancedBaseVertexBaseInstanceWEBGL,
...
var _mono_aot_SharpGLTF_Core_get_method = Module["_mono_aot_SharpGLTF_Core_get_method"] = a0 => (_mono_aot_SharpGLTF_Core_get_method = Module["_mono_aot_SharpGLTF_Core_get_method"] = wasmExports["mono_aot_SharpGLTF_Core_get_method"])(a0);

var _mono_aot_SharpGLTF_Toolkit_get_method = Module["_mono_aot_SharpGLTF_Toolkit_get_method"] = a0 => (_mono_aot_SharpGLTF_Toolkit_get_method = Module["_mono_aot_SharpGLTF_Toolkit_get_method"] = wasmExports["mono_aot_SharpGLTF_Toolkit_get_method"])(a0);
...
var _mono_aot_Ava3D_Demo_get_method = Module["_mono_aot_Ava3D_Demo_get_method"] = a0 => (_mono_aot_Ava3D_Demo_get_method = Module["_mono_aot_Ava3D_Demo_get_method"] = wasmExports["mono_aot_Ava3D_Demo_get_method"])(a0);

var _fmaf = Module["_fmaf"] = (a0, a1, a2) => (_fmaf = Module["_fmaf"] = wasmExports["fmaf"])(a0, a1, a2);

var _mono_aot_Ava3D_get_method = Module["_mono_aot_Ava3D_get_method"] = a0 => (_mono_aot_Ava3D_get_method = Module["_mono_aot_Ava3D_get_method"] = wasmExports["mono_aot_Ava3D_get_method"])(a0);

var _mono_aot_AvaMediaPlayer_get_method = Module["_mono_aot_AvaMediaPlayer_get_method"] = a0 => (_mono_aot_AvaMediaPlayer_get_method = Module["_mono_aot_AvaMediaPlayer_get_method"] = wasmExports["mono_aot_AvaMediaPlayer_get_method"])(a0);

var _mono_aot_Ava3D_Demo_Browser_get_method = Module["_mono_aot_Ava3D_Demo_Browser_get_method"] = a0 => (_mono_aot_Ava3D_Demo_Browser_get_method = Module["_mono_aot_Ava3D_Demo_Browser_get_method"] = wasmExports["mono_aot_Ava3D_Demo_Browser_get_method"])(a0);
