...
public sealed class LightingScene : DemoScene
{
    ...
    {
        var scene = new Scene { Background = Color.FromRgb(10, 11, 15) };

        var ground = new MeshNode(Primitives.Plane(10f, 10f), new Material
        {
        ...
        scene.Children.Add(new MeshNode(Primitives.Sphere(0.7f), new Material
        {
        ...
        scene.Children.Add(new MeshNode(Primitives.Box(0.9f, 0.9f, 0.9f), new Material
        {
